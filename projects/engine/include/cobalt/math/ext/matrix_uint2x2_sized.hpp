...
/// @see core (dependence)
///
/// @defgroup ext_matrix_uint2x2_sized COBALT_EXT_matrix_uint2x2_sized
/// @ingroup ext
///
/// Include <cobalt/math/ext/matrix_uint2x2_sized.hpp> to use the features of this extension.
///
...
#	pragma message("COBALT: COBALT_EXT_matrix_uint2x2_sized extension included")
#endif
