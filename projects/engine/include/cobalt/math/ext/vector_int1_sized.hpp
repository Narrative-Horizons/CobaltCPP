...
///
/// @defgroup ext_vector_int1_sized COBALT_EXT_vector_int1_sized
/// @ingroup ext
///
/// Exposes sized signed integer vector types.
///
/// Include <cobalt/math/ext/vector_int1_sized.hpp> to use the features of this extension.
///
...
#	pragma message("COBALT: COBALT_EXT_vector_int1_sized extension included")
#endif
