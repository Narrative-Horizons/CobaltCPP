...
///
/// @defgroup ext_vector_uint1_sized COBALT_EXT_vector_uint1_sized
/// @ingroup ext
///
/// Exposes sized unsigned integer vector types.
///
/// Include <cobalt/math/ext/vector_uint1_sized.hpp> to use the features of this extension.
///
...
#	pragma message("COBALT: COBALT_EXT_vector_uint1_sized extension included")
#endif
