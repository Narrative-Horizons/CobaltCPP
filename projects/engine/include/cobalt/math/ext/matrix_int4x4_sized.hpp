...
/// @see core (dependence)
///
/// @defgroup ext_matrix_int4x4_sized COBALT_EXT_matrix_int4x4_sized
/// @ingroup ext
///
/// Include <cobalt/math/ext/matrix_int4x4_sized.hpp> to use the features of this extension.
///
...
#	pragma message("COBALT: COBALT_EXT_matrix_int4x4_sized extension included")
#endif
