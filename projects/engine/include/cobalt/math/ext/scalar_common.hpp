...
///
/// @defgroup ext_scalar_common COBALT_EXT_scalar_common
/// @ingroup ext
///
/// Exposes min and max functions for 3 to 4 scalar parameters.
///
/// Include <cobalt/math/ext/scalar_common.hpp> to use the features of this extension.
///
...
#	pragma message("COBALT: COBALT_EXT_scalar_common extension included")
#endif
...
namespace cobalt::math
{
	...
	template<typename T>
	COBALT_FUNC_DECL T min(T a, T b, T c);
	...
	/// @see ext_scalar_common
	template<typename T>
	COBALT_FUNC_DECL T min(T a, T b, T c, T d);
	...
	/// @see ext_scalar_common
	template<typename T>
	COBALT_FUNC_DECL T max(T a, T b, T c);
	...
	/// @see ext_scalar_common
	template<typename T>
	COBALT_FUNC_DECL T max(T a, T b, T c, T d);
	...
	/// @see ext_scalar_common
	template<typename T>
	COBALT_FUNC_DECL T fmin(T a, T b);
	...
	/// @see ext_scalar_common
	template<typename T>
	COBALT_FUNC_DECL T fmin(T a, T b, T c);
	...
	/// @see ext_scalar_common
	template<typename T>
	COBALT_FUNC_DECL T fmin(T a, T b, T c, T d);
	...
	/// @see ext_scalar_common
	template<typename T>
	COBALT_FUNC_DECL T fmax(T a, T b);
	...
	/// @see ext_scalar_common
	template<typename T>
	COBALT_FUNC_DECL T fmax(T a, T b, T C);
	...
	/// @see ext_scalar_common
	template<typename T>
	COBALT_FUNC_DECL T fmax(T a, T b, T C, T D);
	...
	COBALT_FUNC_DECL genType fclamp(genType x, genType minVal, genType maxVal);
	...
	template<typename genType>
	COBALT_FUNC_DECL genType clamp(genType const& Texcoord);
	...
	/// @see ext_scalar_common extension.
	template<typename genType>
	COBALT_FUNC_DECL genType repeat(genType const& Texcoord);
	...
	/// @see ext_scalar_common extension.
	template<typename genType>
	COBALT_FUNC_DECL genType mirrorClamp(genType const& Texcoord);
	...
	/// @see ext_scalar_common extension.
	template<typename genType>
	COBALT_FUNC_DECL genType mirrorRepeat(genType const& Texcoord);
