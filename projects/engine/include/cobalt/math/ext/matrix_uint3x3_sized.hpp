...
/// @see core (dependence)
///
/// @defgroup ext_matrix_uint3x3_sized COBALT_EXT_matrix_uint3x3_sized
/// @ingroup ext
///
/// Include <cobalt/math/ext/matrix_uint3x3_sized.hpp> to use the features of this extension.
///
...
#	pragma message("COBALT: COBALT_EXT_matrix_uint3x3_sized extension included")
#endif
