...
/// @see core (dependence)
///
/// @defgroup gtc_type_aligned COBALT_GTC_type_aligned
/// @ingroup gtc
///
/// Include <cobalt/math/gtc/type_aligned.hpp> to use the features of this extension.
///
...
#	error "COBALT: Aligned gentypes require to enable C++ language extensions. Define COBALT_FORCE_ALIGNED_GENTYPES before including COBALT headers to use aligned types."
#endif

#if COBALT_MESSAGES == COBALT_ENABLE && !defined(COBALT_EXT_INCLUDED)
# pragma message("COBALT: COBALT_GTC_type_aligned extension included")
#endif
...
#if(defined(COBALT_PRECISION_LOWP_FLOAT))
...
#elif(defined(COBALT_PRECISION_MEDIUMP_FLOAT))
...
#else //defined(COBALT_PRECISION_HIGHP_FLOAT)
...
#endif//COBALT_PRECISION

#if(defined(COBALT_PRECISION_LOWP_DOUBLE))
...
#elif(defined(COBALT_PRECISION_MEDIUMP_DOUBLE))
...
#else //defined(COBALT_PRECISION_HIGHP_DOUBLE)
...
#if(defined(COBALT_PRECISION_LOWP_INT))
	typedef aligned_lowp_ivec1			aligned_ivec1;
	typedef aligned_lowp_ivec2			aligned_ivec2;
	typedef aligned_lowp_ivec3			aligned_ivec3;
	typedef aligned_lowp_ivec4			aligned_ivec4;
#elif(defined(COBALT_PRECISION_MEDIUMP_INT))
	typedef aligned_mediump_ivec1		aligned_ivec1;
	typedef aligned_mediump_ivec2		aligned_ivec2;
	typedef aligned_mediump_ivec3		aligned_ivec3;
	typedef aligned_mediump_ivec4		aligned_ivec4;
#else //defined(COBALT_PRECISION_HIGHP_INT)
	/// 1 component vector aligned in memory of signed integer numbers.
...
#if(defined(COBALT_PRECISION_LOWP_UINT))
	typedef aligned_lowp_uvec1			aligned_uvec1;
	typedef aligned_lowp_uvec2			aligned_uvec2;
	typedef aligned_lowp_uvec3			aligned_uvec3;
	typedef aligned_lowp_uvec4			aligned_uvec4;
#elif(defined(COBALT_PRECISION_MEDIUMP_UINT))
	typedef aligned_mediump_uvec1		aligned_uvec1;
	typedef aligned_mediump_uvec2		aligned_uvec2;
	typedef aligned_mediump_uvec3		aligned_uvec3;
	typedef aligned_mediump_uvec4		aligned_uvec4;
#else //defined(COBALT_PRECISION_HIGHP_UINT)
	/// 1 component vector aligned in memory of unsigned integer numbers.
...
#if(defined(COBALT_PRECISION_LOWP_BOOL))
	typedef aligned_lowp_bvec1			aligned_bvec1;
	typedef aligned_lowp_bvec2			aligned_bvec2;
	typedef aligned_lowp_bvec3			aligned_bvec3;
	typedef aligned_lowp_bvec4			aligned_bvec4;
#elif(defined(COBALT_PRECISION_MEDIUMP_BOOL))
	typedef aligned_mediump_bvec1		aligned_bvec1;
	typedef aligned_mediump_bvec2		aligned_bvec2;
	typedef aligned_mediump_bvec3		aligned_bvec3;
	typedef aligned_mediump_bvec4		aligned_bvec4;
#else //defined(COBALT_PRECISION_HIGHP_BOOL)
	/// 1 component vector aligned in memory of bool values.
