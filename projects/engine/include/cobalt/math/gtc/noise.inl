...
namespace gtc
{
	...
	COBALT_FUNC_QUALIFIER vec<4, T, Q> grad4(T const& j, vec<4, T, Q> const& ip)
	{
	...
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER T perlin(vec<2, T, Q> const& Position)
	{
		vec<4, T, Q> Pi = cobalt::math::floor(vec<4, T, Q>(Position.x, Position.y, Position.x, Position.y)) + vec<4, T, Q>(0.0, 0.0, 1.0, 1.0);
		vec<4, T, Q> Pf = cobalt::math::fract(vec<4, T, Q>(Position.x, Position.y, Position.x, Position.y)) - vec<4, T, Q>(0.0, 0.0, 1.0, 1.0);
		...
		vec<4, T, Q> gx = static_cast<T>(2) * cobalt::math::fract(i / T(41)) - T(1);
		vec<4, T, Q> gy = cobalt::math::abs(gx) - T(0.5);
		vec<4, T, Q> tx = cobalt::math::floor(gx + T(0.5));
		gx = gx - tx;
	...
	// Classic Perlin noise
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER T perlin(vec<3, T, Q> const& Position)
	{
	...
	// Classic Perlin noise
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER T perlin(vec<3, T, Q> const& P)
	{
	...
	*/
	// Classic Perlin noise
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER T perlin(vec<4, T, Q> const& Position)
	{
	...
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER T perlin(vec<2, T, Q> const& Position, vec<2, T, Q> const& rep)
	{
	...
	// Classic Perlin noise, periodic variant
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER T perlin(vec<3, T, Q> const& Position, vec<3, T, Q> const& rep)
	{
	...
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER T perlin(vec<4, T, Q> const& Position, vec<4, T, Q> const& rep)
	{
	...
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER T simplex(cobalt::math::vec<2, T, Q> const& v)
	{
	...
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER T simplex(vec<3, T, Q> const& v)
	{
	...
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER T simplex(vec<4, T, Q> const& v)
	{
		vec<4, T, Q> const C(
