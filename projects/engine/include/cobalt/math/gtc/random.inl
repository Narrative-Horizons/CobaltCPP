...
namespace detail
{
	...
	struct compute_rand
	{
		COBALT_FUNC_QUALIFIER static vec<L, T, Q> call();
	};

	template <qualifier P>
	struct compute_rand<1, uint8, P>
	{
		COBALT_FUNC_QUALIFIER static vec<1, uint8, P> call()
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<2, uint8, P> call()
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<3, uint8, P> call()
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<4, uint8, P> call()
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, uint16, Q> call()
		{
			return
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, uint32, Q> call()
		{
			return
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, uint64, Q> call()
		{
			return
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& Min, vec<L, T, Q> const& Max);
	};

	template<length_t L, qualifier Q>
	struct compute_linearRand<L, int8, Q>
	{
		COBALT_FUNC_QUALIFIER static vec<L, int8, Q> call(vec<L, int8, Q> const& Min, vec<L, int8, Q> const& Max)
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, uint8, Q> call(vec<L, uint8, Q> const& Min, vec<L, uint8, Q> const& Max)
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, int16, Q> call(vec<L, int16, Q> const& Min, vec<L, int16, Q> const& Max)
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, uint16, Q> call(vec<L, uint16, Q> const& Min, vec<L, uint16, Q> const& Max)
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, int32, Q> call(vec<L, int32, Q> const& Min, vec<L, int32, Q> const& Max)
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, uint32, Q> call(vec<L, uint32, Q> const& Min, vec<L, uint32, Q> const& Max)
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, int64, Q> call(vec<L, int64, Q> const& Min, vec<L, int64, Q> const& Max)
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, uint64, Q> call(vec<L, uint64, Q> const& Min, vec<L, uint64, Q> const& Max)
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, float, Q> call(vec<L, float, Q> const& Min, vec<L, float, Q> const& Max)
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, double, Q> call(vec<L, double, Q> const& Min, vec<L, double, Q> const& Max)
		{
	...
	{
		COBALT_FUNC_QUALIFIER static vec<L, long double, Q> call(vec<L, long double, Q> const& Min, vec<L, long double, Q> const& Max)
		{
	...
	COBALT_FUNC_QUALIFIER genType linearRand(genType Min, genType Max)
	{
	...
	template<length_t L, typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER vec<L, T, Q> linearRand(vec<L, T, Q> const& Min, vec<L, T, Q> const& Max)
	{
		return detail::compute_linearRand<L, T, Q>::call(Min, Max);
	}

	template<typename genType>
	COBALT_FUNC_QUALIFIER genType gaussRand(genType Mean, genType Deviation)
	{
		genType w, x1, x2;
	...
	template<length_t L, typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER vec<L, T, Q> gaussRand(vec<L, T, Q> const& Mean, vec<L, T, Q> const& Deviation)
	{
		return detail::functor2<vec, L, T, Q>::call(gaussRand, Mean, Deviation);
	}

	template<typename T>
	COBALT_FUNC_QUALIFIER vec<2, T, defaultp> diskRand(T Radius)
	{
	...
	template<typename T>
	COBALT_FUNC_QUALIFIER vec<3, T, defaultp> ballRand(T Radius)
	{
		assert(Radius > static_cast<T>(0));
	...
	template<typename T>
	COBALT_FUNC_QUALIFIER vec<2, T, defaultp> circularRand(T Radius)
	{
		assert(Radius > static_cast<T>(0));

		T a = linearRand(T(0), static_cast<T>(6.283185307179586476925286766559));
		return vec<2, T, defaultp>(cobalt::math::cos(a), cobalt::math::sin(a)) * Radius;
	}

	template<typename T>
	COBALT_FUNC_QUALIFIER vec<3, T, defaultp> sphericalRand(T Radius)
	{
		assert(Radius > static_cast<T>(0));
