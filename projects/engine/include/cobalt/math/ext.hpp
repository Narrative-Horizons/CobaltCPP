...
#if COBALT_MESSAGES == COBALT_ENABLE && !defined(COBALT_MESSAGE_EXT_INCLUDED_DISPLAYED)
#	define COBALT_MESSAGE_EXT_INCLUDED_DISPLAYED
#	pragma message("COBALT: All extensions included (not recommended)")
...
#ifdef COBALT_ENABLE_EXPERIMENTAL
...
#if COBALT_HAS_RANGE_FOR
#	include "./gtx/range.hpp"
#endif
#endif//COBALT_ENABLE_EXPERIMENTAL
