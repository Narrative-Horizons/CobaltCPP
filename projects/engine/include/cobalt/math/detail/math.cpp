...
#define COBALT_ENABLE_EXPERIMENTAL
#endif
#include <cobalt/math/gtx/dual_quaternion.hpp>
#include <cobalt/math/gtc/vec1.hpp>
#include <cobalt/math/gtc/quaternion.hpp>
#include <cobalt/math/ext/scalar_int_sized.hpp>
#include <cobalt/math/ext/scalar_uint_sized.hpp>
