...
namespace detail
{
	...
	{
	protected:
		COBALT_FUNC_QUALIFIER T& elem(size_t i){ return (reinterpret_cast<T*>(_buffer))[i]; }
		COBALT_FUNC_QUALIFIER T const& elem(size_t i) const{ return (reinterpret_cast<const T*>(_buffer))[i]; }
	...
	{
		COBALT_FUNC_QUALIFIER vec<2, T, Q> operator ()()  const { return vec<2, T, Q>(this->elem(E0), this->elem(E1)); }
	};
	...
	{
		COBALT_FUNC_QUALIFIER vec<3, T, Q> operator ()()  const { return vec<3, T, Q>(this->elem(E0), this->elem(E1), this->elem(E2)); }
	};
	...
	{
		COBALT_FUNC_QUALIFIER vec<4, T, Q> operator ()()  const { return vec<4, T, Q>(this->elem(E0), this->elem(E1), this->elem(E2), this->elem(E3)); }
	};
	...
	*/
	...
	struct _swizzle_base2 : public _swizzle_base1<N, T, Q, E0,E1,E2,E3, detail::is_aligned<Q>::value>
	{
		struct op_equal
		{
			COBALT_FUNC_QUALIFIER void operator() (T& e, T& t) const{ e = t; }
		};
	...
	public:
		COBALT_FUNC_QUALIFIER _swizzle_base2& operator= (const T& t)
		{
			for (int i = 0; i < N; ++i)
				(*this)[i] = t;
			return *this;
		...
		COBALT_FUNC_QUALIFIER _swizzle_base2& operator= (vec<N, T, Q> const& that)
		{
			_apply_op(that, op_equal());
			return *this;
		}

		COBALT_FUNC_QUALIFIER void operator -= (vec<N, T, Q> const& that)
		{
		...
		COBALT_FUNC_QUALIFIER T& operator[](size_t i)
		{
			const int offset_dst[4] = { E0, E1, E2, E3 };
			return this->elem(offset_dst[i]);
		}
		COBALT_FUNC_QUALIFIER T operator[](size_t i) const
		{
			const int offset_dst[4] = { E0, E1, E2, E3 };
			return this->elem(offset_dst[i]);
		}
	...
	protected:
		template<typename U>
		COBALT_FUNC_QUALIFIER void _apply_op(vec<N, T, Q> const& that, const U& op)
		{
	...
	struct _swizzle_base2<N, T, Q, E0,E1,E2,E3, 1> : public _swizzle_base1<N, T, Q, E0,E1,E2,E3, detail::is_aligned<Q>::value>
	{
		...
		COBALT_FUNC_QUALIFIER _swizzle_base2& operator= (Stub const&) { return *this; }
	...
	struct _swizzle : public _swizzle_base2<N, T, Q, E0, E1, E2, E3, (E0 == E1 || E0 == E2 || E0 == E3 || E1 == E2 || E1 == E3 || E2 == E3)>
	{
		...
		COBALT_FUNC_QUALIFIER operator vec<N, T, Q> () const { return (*this)(); }
	};

//
// To prevent the C++ syntax from getting entirely overwhelming, define some alias macros
//
#define COBALT_SWIZZLE_TEMPLATE1   template<int N, typename T, qualifier Q, int E0, int E1, int E2, int E3>
#define COBALT_SWIZZLE_TEMPLATE2   template<int N, typename T, qualifier Q, int E0, int E1, int E2, int E3, int F0, int F1, int F2, int F3>
#define COBALT_SWIZZLE_TYPE1       _swizzle<N, T, Q, E0, E1, E2, E3>
#define COBALT_SWIZZLE_TYPE2       _swizzle<N, T, Q, F0, F1, F2, F3>

//
// Wrapper for a binary operator (e.g. u.yy + v.zy)
//
#define COBALT_SWIZZLE_VECTOR_BINARY_OPERATOR_IMPLEMENTATION(OPERAND)                 \
	COBALT_SWIZZLE_TEMPLATE2                                                          \
	COBALT_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND ( const COBALT_SWIZZLE_TYPE1& a, const COBALT_SWIZZLE_TYPE2& b)  \
	{                                                                               \
		return a() OPERAND b();                                                     \
	}                                                                               \
	COBALT_SWIZZLE_TEMPLATE1                                                          \
	COBALT_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND ( const COBALT_SWIZZLE_TYPE1& a, const vec<N, T, Q>& b)                   \
	{                                                                               \
		return a() OPERAND b;                                                       \
	}                                                                               \
	COBALT_SWIZZLE_TEMPLATE1                                                          \
	COBALT_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND ( const vec<N, T, Q>& a, const COBALT_SWIZZLE_TYPE1& b)                   \
	{                                                                               \
		return a OPERAND b();                                                       \
	}
...
//
#define COBALT_SWIZZLE_SCALAR_BINARY_OPERATOR_IMPLEMENTATION(OPERAND)								\
	COBALT_SWIZZLE_TEMPLATE1																		\
	COBALT_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND ( const COBALT_SWIZZLE_TYPE1& a, const T& b)	\
	{																							\
		return a() OPERAND b;																	\
	}																							\
	COBALT_SWIZZLE_TEMPLATE1																		\
	COBALT_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND ( const T& a, const COBALT_SWIZZLE_TYPE1& b)	\
	{																							\
		return a OPERAND b();																	\
	}
...
//
#define COBALT_SWIZZLE_FUNCTION_1_ARGS(RETURN_TYPE,FUNCTION)												\
	COBALT_SWIZZLE_TEMPLATE1																				\
	COBALT_FUNC_QUALIFIER typename COBALT_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const COBALT_SWIZZLE_TYPE1& a)		\
	{																									\
		return FUNCTION(a());																			\
	}
...
//
#define COBALT_SWIZZLE_FUNCTION_2_ARGS(RETURN_TYPE,FUNCTION)                                                       \
	COBALT_SWIZZLE_TEMPLATE2                                                                                       \
	COBALT_FUNC_QUALIFIER typename COBALT_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const COBALT_SWIZZLE_TYPE1& a, const COBALT_SWIZZLE_TYPE2& b) \
	{                                                                                                           \
		return FUNCTION(a(), b());                                                                              \
	}                                                                                                           \
	COBALT_SWIZZLE_TEMPLATE1                                                                                       \
	COBALT_FUNC_QUALIFIER typename COBALT_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const COBALT_SWIZZLE_TYPE1& a, const COBALT_SWIZZLE_TYPE1& b) \
	{                                                                                                           \
		return FUNCTION(a(), b());                                                                              \
	}                                                                                                           \
	COBALT_SWIZZLE_TEMPLATE1                                                                                       \
	COBALT_FUNC_QUALIFIER typename COBALT_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const COBALT_SWIZZLE_TYPE1& a, const typename V& b)         \
	{                                                                                                           \
		return FUNCTION(a(), b);                                                                                \
	}                                                                                                           \
	COBALT_SWIZZLE_TEMPLATE1                                                                                       \
	COBALT_FUNC_QUALIFIER typename COBALT_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const V& a, const COBALT_SWIZZLE_TYPE1& b)                  \
	{                                                                                                           \
		return FUNCTION(a, b());                                                                                \
	}
...
//
#define COBALT_SWIZZLE_FUNCTION_2_ARGS_SCALAR(RETURN_TYPE,FUNCTION)                                                             \
	COBALT_SWIZZLE_TEMPLATE2                                                                                                    \
	COBALT_FUNC_QUALIFIER typename COBALT_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const COBALT_SWIZZLE_TYPE1& a, const COBALT_SWIZZLE_TYPE2& b, const T& c)   \
	{                                                                                                                         \
		return FUNCTION(a(), b(), c);                                                                                         \
	}                                                                                                                         \
	COBALT_SWIZZLE_TEMPLATE1                                                                                                    \
	COBALT_FUNC_QUALIFIER typename COBALT_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const COBALT_SWIZZLE_TYPE1& a, const COBALT_SWIZZLE_TYPE1& b, const T& c)   \
	{                                                                                                                         \
		return FUNCTION(a(), b(), c);                                                                                         \
	}                                                                                                                         \
	COBALT_SWIZZLE_TEMPLATE1                                                                                                    \
	COBALT_FUNC_QUALIFIER typename COBALT_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const COBALT_SWIZZLE_TYPE1& a, const typename S0::vec_type& b, const T& c)\
	{                                                                                                                         \
		return FUNCTION(a(), b, c);                                                                                           \
	}                                                                                                                         \
	COBALT_SWIZZLE_TEMPLATE1                                                                                                    \
	COBALT_FUNC_QUALIFIER typename COBALT_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const typename V& a, const COBALT_SWIZZLE_TYPE1& b, const T& c)           \
	{                                                                                                                         \
		return FUNCTION(a, b(), c);                                                                                           \
	}
...
namespace cobalt::math
{
	namespace detail
	{
		COBALT_SWIZZLE_SCALAR_BINARY_OPERATOR_IMPLEMENTATION(-)
		COBALT_SWIZZLE_SCALAR_BINARY_OPERATOR_IMPLEMENTATION(*)
		COBALT_SWIZZLE_VECTOR_BINARY_OPERATOR_IMPLEMENTATION(+)
		COBALT_SWIZZLE_VECTOR_BINARY_OPERATOR_IMPLEMENTATION(-)
		COBALT_SWIZZLE_VECTOR_BINARY_OPERATOR_IMPLEMENTATION(*)
		COBALT_SWIZZLE_VECTOR_BINARY_OPERATOR_IMPLEMENTATION(/)
	}
	...
	//COBALT_SWIZZLE_FUNCTION_1_ARGS(vec_type,    abs);
	//COBALT_SWIZZLE_FUNCTION_1_ARGS(vec_type,    acos);
	//COBALT_SWIZZLE_FUNCTION_1_ARGS(vec_type,    acosh);
	//COBALT_SWIZZLE_FUNCTION_1_ARGS(vec_type,    all);
	//COBALT_SWIZZLE_FUNCTION_1_ARGS(vec_type,    any);

	//COBALT_SWIZZLE_FUNCTION_2_ARGS(value_type,  dot);
	//COBALT_SWIZZLE_FUNCTION_2_ARGS(vec_type,    cross);
	//COBALT_SWIZZLE_FUNCTION_2_ARGS(vec_type,    step);
	//COBALT_SWIZZLE_FUNCTION_2_ARGS_SCALAR(vec_type, mix);
}

#define COBALT_SWIZZLE2_2_MEMBERS(T, Q, E0,E1) \
...
#define COBALT_SWIZZLE2_3_MEMBERS(T, Q, E0,E1) \
...
#define COBALT_SWIZZLE2_4_MEMBERS(T, Q, E0,E1) \
...
#define COBALT_SWIZZLE3_2_MEMBERS(T, Q, E0,E1,E2) \
	struct { detail::_swizzle<2,T, Q, 0,0,-1,-2> E0 ## E0; }; \
	struct { detail::_swizzle<2,T, Q, 0,1,-1,-2> E0 ## E1; }; \
...
#define COBALT_SWIZZLE3_3_MEMBERS(T, Q ,E0,E1,E2) \
	struct { detail::_swizzle<3, T, Q, 0,0,0,-1> E0 ## E0 ## E0; }; \
	struct { detail::_swizzle<3, T, Q, 0,0,1,-1> E0 ## E0 ## E1; }; \
...
#define COBALT_SWIZZLE3_4_MEMBERS(T, Q, E0,E1,E2) \
	struct { detail::_swizzle<4,T, Q, 0,0,0,0> E0 ## E0 ## E0 ## E0; }; \
	struct { detail::_swizzle<4,T, Q, 0,0,0,1> E0 ## E0 ## E0 ## E1; }; \
...
#define COBALT_SWIZZLE4_2_MEMBERS(T, Q, E0,E1,E2,E3) \
	struct { detail::_swizzle<2,T, Q, 0,0,-1,-2> E0 ## E0; }; \
	struct { detail::_swizzle<2,T, Q, 0,1,-1,-2> E0 ## E1; }; \
	struct { detail::_swizzle<2,T, Q, 0,2,-1,-2> E0 ## E2; }; \
...
#define COBALT_SWIZZLE4_3_MEMBERS(T, Q, E0,E1,E2,E3) \
	struct { detail::_swizzle<3, T, Q, 0,0,0,-1> E0 ## E0 ## E0; }; \
	struct { detail::_swizzle<3, T, Q, 0,0,1,-1> E0 ## E0 ## E1; }; \
	struct { detail::_swizzle<3, T, Q, 0,0,2,-1> E0 ## E0 ## E2; }; \
...
#define COBALT_SWIZZLE4_4_MEMBERS(T, Q, E0,E1,E2,E3) \
	struct { detail::_swizzle<4, T, Q, 0,0,0,0> E0 ## E0 ## E0 ## E0; }; \
	struct { detail::_swizzle<4, T, Q, 0,0,0,1> E0 ## E0 ## E0 ## E1; }; \
	struct { detail::_swizzle<4, T, Q, 0,0,0,2> E0 ## E0 ## E0 ## E2; }; \
