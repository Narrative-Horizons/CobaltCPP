...
namespace cobalt::math
{
	...
	COBALT_FUNC_QUALIFIER vec<3, T, Q> rgb2YCoCg
	(
	...
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER vec<3, T, Q> YCoCg2rgb
	(
	...
	public:
		static COBALT_FUNC_QUALIFIER vec<3, T, Q> rgb2YCoCgR
		(
			vec<3, T, Q> const& rgbColor
		)
		{
		...
		static COBALT_FUNC_QUALIFIER vec<3, T, Q> YCoCgR2rgb
		(
	...
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER vec<3, T, Q> rgb2YCoCgR
	(
		vec<3, T, Q> const& rgbColor
	)
	{
	...
	template<typename T, qualifier Q>
	COBALT_FUNC_QUALIFIER vec<3, T, Q> YCoCgR2rgb
	(
		vec<3, T, Q> const& YCoCgRColor
	)
	{
