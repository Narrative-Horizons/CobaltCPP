...
///
/// The COBALT core consists of C++ types that mirror GLSL types and
/// C++ functions that mirror the GLSL functions.
///
/// The best documentation for COBALT Core is the current GLSL specification,
/// <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.clean.pdf">version 4.2
/// (pdf file)</a>.
///
/// COBALT core functionalities require <cobalt/math/math.hpp> to be included to be used.
///
///
...
///
/// C++ has no language equivalent to qualifier qualifiers. So COBALT provides the next-best thing:
...
/// including <cobalt/math/ext.hpp>. Otherwise, each extension needs to be included  a specific file.
///
///
...
/// at once by including <cobalt/math/ext.hpp>. Otherwise, each extension needs to be
/// included  a specific file.
///
/// @mainpage OpenGL Mathematics (COBALT)
/// - Website: <a href="https://glm.g-truc.net">glm.g-truc.net</a>
/// - <a href="modules.html">COBALT API documentation</a>
/// - <a href="https://github.com/g-truc/glm/blob/master/manual.md">COBALT Manual</a>
